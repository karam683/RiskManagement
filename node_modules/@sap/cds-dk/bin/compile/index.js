...
function compile (models, options={}) {
  ...
  'xsuaa' in cds.compile.to || Object.defineProperties (cds.compile.to,{
    'xsuaa':   {get:()=> require('./to-xsuaa')},
    'openapi': {get:()=> require('../../lib/compile/openapi')},
    'edmx-v2': {value: (csn,o) => cds.compile.to.edmx(csn,{...o,flavor:'v2'}) },
    'edmx-v4': {value: (csn,o) => cds.compile.to.edmx(csn,{...o,flavor:'v4'}) },
    'edmx-w4': {value: (csn,o) => cds.compile.to.edmx(csn,{...o,flavor:'w4'}) },
    'edmx-x4': {value: (csn,o) => cds.compile.to.edmx(csn,{...o,flavor:'x4'}) },
  })
