...
module.exports = class ProjectReader {
    ...
    async _getCapDescriptor(env) {
        let capDescriptor = {
            ...
            requires: [],
            get isMultitenant() {
                return this.requires.multitenancy ||
                    this.requires.multitenancy === undefined && this.requires.some(req => req.resource.isMultitenant)
            },
            get isNodejs() {
            ...
            get needsSidecar() {
                // {{#if (and (gt cap.db.length 0) (or (eq cap.pLanguage 'java') (ne cap.isMultitenant true) ) ) }}
